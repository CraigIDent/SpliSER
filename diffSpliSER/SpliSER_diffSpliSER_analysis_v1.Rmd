...
SpliSER_filt <- SpliSER_narm[SpliSER_SSE$meanSSE>0.05 & SpliSER_SSE$meanSSE<0.95,] 
SpliSER_filt
...
```{r}
hits_intersect <- merge(hits, SpliSER_filt, by=c("Region","Site","Gene","Strand")) 
...
#Condition 1 average (ie all of your control samples) - remember to update the denominator if you have more/less than 3 replicates
hits_intersect$avg1 = (hits_intersect$ColA_SSE + hits_intersect$ColB_SSE +hits_intersect$ColC_SSE)/3
#Condition 2 average (ie all of your test samples) - remember to update the denominator if you have more/less than 3 replicates
